App = {
  ...
  KYCStatus: async () => {
    ...
    docLinkElement.innerHTML = `<a href="/img/GreenCreditManagement_GreenSolutionsInc.pdf" target="_blank">View Document</a>`;
  },
  ...
  FetchKYCIndustry: async () => {
    ...
    for (var j = 0; j <= certificateCount; j++) {
      ...
      html += `<tr>
          ...
          <td>${kycStatus}</td>
          <td style="color:green;"><button onclick="App.KYCVerification('${certificate[2]}')" class='btn'></button> </td>
          </tr>`;
      j += 1;
    }
